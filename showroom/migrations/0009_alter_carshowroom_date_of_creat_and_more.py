...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('showroom', '0008_alter_carshowroom_date_of_creat_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='show_room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='show_room_stocks', to='showroom.carshowroom'),
        ),
    ]
